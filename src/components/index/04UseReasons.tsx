...
import styles from '@/styles/modules/UseReasons.module.scss';
import { ComponentType, useEffect } from 'react';
import { SVGProps } from '@/utils/SVGProps.ts';

const icons: { [key: string]: ComponentType<SVGProps> } = {
  SunIcon: dynamic(() => import('../icons/SunIcon.tsx')),
  CloudyIcon: dynamic(() => import('../icons/CloudyIcon.tsx')),
  SunCloudyIcon: dynamic(() => import('../icons/SunCloudyIcon.tsx')),
};
