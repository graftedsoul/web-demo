      ...
      <div className='d-flex flex-column flex-lg-row-reverse justify-content-end gap-5 gap-md-3'>
        ...
        >
            ...
            <div className='col-12 col-sm'>
              <div className='form-floating'>
                <input
                  ...
                  placeholder='John'
                />
                <label htmlFor='index_contactInputName'>First Name</label>
              </div>
            </div>
            ...
            <div className='col-12 col-sm'>
              <div className='form-floating'>
                <input
                  ...
                  placeholder='John'
                />
                <label htmlFor='index_contactInputSurname'>Last Name</label>
              </div>
            </div>
          </div>
          ...
          <div className='form-floating col-12'>
            ...
            ></textarea>
            <label htmlFor='index_contactInputMessage'>Message</label>
          </div>
        ...
        <div className='map_container col col-lg-7 d-flex flex-column gap-3'>
          ...
          <span className='address text_small col-10 col-sm-8'>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, 6/66,
            0612345, Phasellus/ERAT LACUS
          </span>
        </div>
      </div>
    </section>
